...
/*
  ...
  FICA-CIERCOM
  Christofer Macas
  Reloj con alarma almacenada en EEPROM 
...
int sw = 0;// variables para las interrupciones
...
void loop() {
  ...
  alarma();// activar alarmar
   if (sw == 1) {// si la interruccion da dos pulsos se activa la configuracion de alarma
    configalarm();// metodo
    delay(200);
